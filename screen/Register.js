...
const Register = ({ navigation }) => {
    ...
    const onSubmit = () => {
        ...
        axios.post('http://192.168.0.106:3000/users', fromData)
            .then((respone) =>
                {
                    if(respone.data){
                        Alert.alert(` Người dùng tên ${respone.data.name} đã đăng ký thành công `);
            ...
            <ScrollView>
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={styles.bgbutton}>
                        <Text style={{ padding: 8, fontSize: 17, color: '#d5dcf2' }} onPress={() => onSubmit()}>Register</Text>
                    </TouchableOpacity>
                    <TouchableOpacity >
